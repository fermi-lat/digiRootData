//
// File generated by C:\heather\extlib\Root\v3\bin\rootcint at Tue Jun 26 18:21:31 2001.
...
static int G__AcdDigi_AcdDigi_1_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   AcdDigi *p=NULL;
      p = new AcdDigi((UShort_t)G__int(libp->para[0]));
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__EventCintLN_AcdDigi);
...
static int G__AcdDigi_getId_3_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AcdDigi*)(G__getstructoffset()))->getId());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_getPulseHeight_4_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,114,(long)((AcdDigi*)(G__getstructoffset()))->getPulseHeight());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_getVeto_5_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((AcdDigi*)(G__getstructoffset()))->getVeto());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_setPulseHeight_6_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((AcdDigi*)(G__getstructoffset()))->setPulseHeight((UShort_t)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_setVeto_7_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((AcdDigi*)(G__getstructoffset()))->setVeto((UChar_t)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_Compare_8_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((const AcdDigi*)(G__getstructoffset()))->Compare((const TObject*)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_IsSortable_9_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((const AcdDigi*)(G__getstructoffset()))->IsSortable());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_Class_0_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AcdDigi*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_Class_Name_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AcdDigi*)(G__getstructoffset()))->Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_Class_Version_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((AcdDigi*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_Dictionary_3_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AcdDigi*)(G__getstructoffset()))->Dictionary();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_IsA_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((const AcdDigi*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_ShowMembers_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AcdDigi*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_Streamer_6_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AcdDigi*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_StreamerNVirtual_7_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AcdDigi*)(G__getstructoffset()))->StreamerNVirtual(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_DeclFileName_8_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AcdDigi*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_DeclFileLine_9_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AcdDigi*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_ImplFileName_0_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AcdDigi*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__AcdDigi_ImplFileLine_1_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AcdDigi*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__AcdDigi_AcdDigi_2_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   AcdDigi *p;
...
static int G__AcdDigi_wAAcdDigi_3_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
...
static int G__CalDigi_Compare_2_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((const CalDigi*)(G__getstructoffset()))->Compare((const TObject*)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_IsSortable_3_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((const CalDigi*)(G__getstructoffset()))->IsSortable());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_getAdc_9_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,114,(long)((const CalDigi*)(G__getstructoffset()))->getAdc((CalDigi::LogFace)G__int(libp->para[0]),(short)G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_getAdcSelectedRange_0_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 2:
      G__letint(result7,114,(long)((const CalDigi*)(G__getstructoffset()))->getAdcSelectedRange((CalDigi::LogFace)G__int(libp->para[0]),(CalDigi::AdcRange)G__int(libp->para[1])));
      break;
   case 1:
      G__letint(result7,114,(long)((const CalDigi*)(G__getstructoffset()))->getAdcSelectedRange((CalDigi::LogFace)G__int(libp->para[0])));
      break;
   }
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_getRange_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,114,(long)((const CalDigi*)(G__getstructoffset()))->getRange((CalDigi::LogFace)G__int(libp->para[0]),(short)G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_getMode_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((const CalDigi*)(G__getstructoffset()))->getMode());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_setAdcValue_3_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 3:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcValue((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])
,(CalDigi::AdcRange)G__int(libp->para[2])));
      break;
   case 2:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcValue((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])));
      break;
...
static int G__CalDigi_setAdcId_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 3:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcId((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])
,(CalDigi::AdcRange)G__int(libp->para[2])));
      break;
   case 2:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcId((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])));
...
static int G__CalDigi_setAdcPinId_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 3:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcPinId((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])
,(CalDigi::AdcRange)G__int(libp->para[2])));
      break;
   case 2:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcPinId((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])));
...
static int G__CalDigi_setAdcRangeScale_6_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 3:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcRangeScale((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])
,(CalDigi::AdcRange)G__int(libp->para[2])));
      break;
   case 2:
      G__letint(result7,98,(long)((CalDigi*)(G__getstructoffset()))->setAdcRangeScale((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])));
...
static int G__CalDigi_setAdcWord_7_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 3:
      G__setnull(result7);
      ((CalDigi*)(G__getstructoffset()))->setAdcWord((UShort_t)G__int(libp->para[0]),(CalDigi::LogFace)G__int(libp->para[1])
,(CalDigi::AdcRange)G__int(libp->para[2]));
      break;
   case 2:
      G__setnull(result7);
...
static int G__CalDigi_setTriggerMode_8_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((CalDigi*)(G__getstructoffset()))->setTriggerMode((CalDigi::CalTrigMode)G__int(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_getCalLogId_9_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((CalDigi*)(G__getstructoffset()))->getCalLogId());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_Class_0_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((CalDigi*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_Class_Name_1_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((CalDigi*)(G__getstructoffset()))->Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_Class_Version_2_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((CalDigi*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_Dictionary_3_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((CalDigi*)(G__getstructoffset()))->Dictionary();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_IsA_4_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((const CalDigi*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_ShowMembers_5_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((CalDigi*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_Streamer_6_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((CalDigi*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_StreamerNVirtual_7_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((CalDigi*)(G__getstructoffset()))->StreamerNVirtual(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_DeclFileName_8_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((CalDigi*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_DeclFileLine_9_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((CalDigi*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_ImplFileName_0_3(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((CalDigi*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CalDigi_ImplFileLine_1_3(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((CalDigi*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__CalDigi_CalDigi_2_3(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   CalDigi *p;
...
static int G__CalDigi_wACalDigi_3_3(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
...
static int G__TkrDigi_TkrDigi_1_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   TkrDigi *p=NULL;
      p = new TkrDigi((TObjArray*)G__int(libp->para[0]));
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__EventCintLN_TkrDigi);
...
static int G__TkrDigi_Clean_3_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 1:
      G__setnull(result7);
...
static int G__TkrDigi_getStrips_4_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((TkrDigi*)(G__getstructoffset()))->getStrips());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_setToT_5_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->setToT((UInt_t)G__int(libp->para[0]),(UInt_t)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_setErrf_6_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->setErrf((UInt_t)G__int(libp->para[0]),(UInt_t)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_setLayerNum_7_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->setLayerNum((UChar_t)G__int(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_setXY_8_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->setXY((TkrDigi::TKRAxes)G__int(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_getToT_9_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((TkrDigi*)(G__getstructoffset()))->getToT((UChar_t)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_getErrf_0_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((TkrDigi*)(G__getstructoffset()))->getErrf((UChar_t)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_getLayerNum_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((const TkrDigi*)(G__getstructoffset()))->getLayerNum());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_getXY_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((const TkrDigi*)(G__getstructoffset()))->getXY());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_getNumHits_3_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,104,(long)((TkrDigi*)(G__getstructoffset()))->getNumHits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_getHit_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((TkrDigi*)(G__getstructoffset()))->getHit((int)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_Compare_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((const TkrDigi*)(G__getstructoffset()))->Compare((const TObject*)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_IsSortable_6_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((const TkrDigi*)(G__getstructoffset()))->IsSortable());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_Class_7_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((TkrDigi*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_Class_Name_8_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((TkrDigi*)(G__getstructoffset()))->Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_Class_Version_9_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((TkrDigi*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_Dictionary_0_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->Dictionary();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_IsA_1_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((const TkrDigi*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_ShowMembers_2_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_Streamer_3_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_StreamerNVirtual_4_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrDigi*)(G__getstructoffset()))->StreamerNVirtual(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_DeclFileName_5_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((TkrDigi*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_DeclFileLine_6_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((TkrDigi*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_ImplFileName_7_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((TkrDigi*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrDigi_ImplFileLine_8_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((TkrDigi*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__TkrDigi_TkrDigi_9_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   TkrDigi *p;
...
static int G__TkrDigi_wATkrDigi_0_3(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
...
static int G__Event_addAcdDigi_9_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((Event*)(G__getstructoffset()))->addAcdDigi((UShort_t)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__Event_getCalDigi_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((Event*)(G__getstructoffset()))->getCalDigi());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Event_addCalDigi_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((Event*)(G__getstructoffset()))->addCalDigi());
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__Event_getTkrDigi_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((Event*)(G__getstructoffset()))->getTkrDigi());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Event_addTkrDigi_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((Event*)(G__getstructoffset()))->addTkrDigi((TkrDigi*)G__int(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static void G__setup_memvarAcdDigi(void) {
   ...
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_AcdDigicLcLdA),-1,-2,1,"ACD_K_PMT=12",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_AcdDigicLcLdA),-1,-2,1,"ACD_V_PMT=0",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_AcdDigicLcLdA),-1,-2,1,"ACD_M_PMT=4095",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_AcdDigicLcLdA),-1,-2,1,"ACD_K_HIT=4",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_AcdDigicLcLdA),-1,-2,1,"ACD_V_HIT=12",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_AcdDigicLcLdA),-1,-2,1,"ACD_M_HIT=15",0,(char*)NULL);
...
static void G__setup_memvarCalDigi(void) {
   ...
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLAdcRange),-1,-2,1,"LowEnX4=0",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLAdcRange),-1,-2,1,"LowEnX1=1",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLAdcRange),-1,-2,1,"HiEnX8=2",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLAdcRange),-1,-2,1,"HiEnX1=3",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLLogFace),-1,-2,1,"POS=0",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLLogFace),-1,-2,1,"NEG=1",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLCalTrigMode),-1,-2,1,"BESTRANGE=0",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLCalTrigMode),-1,-2,1,"ALLRANGE=2",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_K_RS=1",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_V_RS=0",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_M_RS=1",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_K_PIN=1",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_V_PIN=1",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_M_PIN=1",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_K_ID=2",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_V_ID=2",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_M_ID=3",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_K_VAL=12",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_V_VAL=4",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLdA),-1,-2,1,"ADC_M_VAL=4095",0,(char*)NULL);
   ...
   G__memvar_setup((void*)NULL,105,0,0,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLCalTrigMode),G__defined_typename("CalTrigMode"),-2,4,"m_mode=",0,(char*)NULL);
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarTkrDigi(void) {
   ...
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_TkrDigicLcLTKRAxes),-1,-2,1,"X=0",0,(char*)NULL);
   G__memvar_setup((void*)G__PVOID,105,0,1,G__get_linked_tagnum(&G__EventCintLN_TkrDigicLcLTKRAxes),-1,-2,1,"Y=1",0,(char*)NULL);
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncAcdDigi(void) {
   ...
   G__memfunc_setup("AcdDigi",645,G__AcdDigi_AcdDigi_1_0,105,G__get_linked_tagnum(&G__EventCintLN_AcdDigi),-1,0,1,1,1,0,"r - 'UShort_t' 0 - id",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getId",493,G__AcdDigi_getId_3_0,85,G__get_linked_tagnum(&G__EventCintLN_AcdId),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getPulseHeight",1442,G__AcdDigi_getPulseHeight_4_0,114,-1,G__defined_typename("UShort_t"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getVeto",734,G__AcdDigi_getVeto_5_0,98,-1,G__defined_typename("UChar_t"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setPulseHeight",1454,G__AcdDigi_setPulseHeight_6_0,98,-1,G__defined_typename("Bool_t"),0,1,1,1,0,"r - 'UShort_t' 0 - phaVal",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setVeto",746,G__AcdDigi_setVeto_7_0,98,-1,G__defined_typename("Bool_t"),0,1,1,1,0,"b - 'UChar_t' 0 - hitVal",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Compare",711,G__AcdDigi_Compare_8_0,105,-1,G__defined_typename("Int_t"),0,1,1,1,8,"U 'TObject' - 10 - obj",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("IsSortable",1016,G__AcdDigi_IsSortable_9_0,98,-1,G__defined_typename("Bool_t"),0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Class",502,G__AcdDigi_Class_0_1,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Name",982,G__AcdDigi_Class_Name_1_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__AcdDigi_Class_Version_2_1,115,-1,G__defined_typename("Version_t"),0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__AcdDigi_Dictionary_3_1,121,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__AcdDigi_IsA_4_1,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__AcdDigi_ShowMembers_5_1,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__AcdDigi_Streamer_6_1,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("StreamerNVirtual",1656,G__AcdDigi_StreamerNVirtual_7_1,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__AcdDigi_DeclFileName_8_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__AcdDigi_DeclFileLine_9_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__AcdDigi_ImplFileName_0_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__AcdDigi_ImplFileLine_1_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("AcdDigi",645,G__AcdDigi_AcdDigi_2_2,(int)('i'),G__get_linked_tagnum(&G__EventCintLN_AcdDigi),-1,0,1,1,1,0,"u 'AcdDigi' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~AcdDigi",771,G__AcdDigi_wAAcdDigi_3_2,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncCalDigi(void) {
   ...
   G__memfunc_setup("Compare",711,G__CalDigi_Compare_2_0,105,-1,G__defined_typename("Int_t"),0,1,1,1,8,"U 'TObject' - 10 - obj",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("IsSortable",1016,G__CalDigi_IsSortable_3_0,98,-1,G__defined_typename("Bool_t"),0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("getAdc",584,G__CalDigi_getAdc_9_0,114,-1,G__defined_typename("UShort_t"),0,2,1,1,8,
"u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face s - - 0 - index",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getAdcSelectedRange",1886,G__CalDigi_getAdcSelectedRange_0_1,114,-1,G__defined_typename("UShort_t"),0,2,1,1,8,
"u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face u 'CalDigi::AdcRange' 'CalDigi::AdcRange' 0 LowEnX4 range",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getRange",813,G__CalDigi_getRange_1_1,114,-1,G__defined_typename("UShort_t"),0,2,1,1,8,
"u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face s - - 0 - index",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getMode",709,G__CalDigi_getMode_2_1,105,G__get_linked_tagnum(&G__EventCintLN_CalDigicLcLCalTrigMode),G__defined_typename("CalDigi::CalTrigMode"),0,0,1,1,9,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setAdcValue",1105,G__CalDigi_setAdcValue_3_1,98,-1,G__defined_typename("Bool_t"),0,3,1,1,0,
"r - 'UShort_t' 0 - newVal u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face "
"u 'CalDigi::AdcRange' 'CalDigi::AdcRange' 0 LowEnX4 range",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setAdcId",769,G__CalDigi_setAdcId_4_1,98,-1,G__defined_typename("Bool_t"),0,3,1,1,0,
"r - 'UShort_t' 0 - newVal u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face "
"u 'CalDigi::AdcRange' 'CalDigi::AdcRange' 0 LowEnX4 range",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setAdcPinId",1064,G__CalDigi_setAdcPinId_5_1,98,-1,G__defined_typename("Bool_t"),0,3,1,1,0,
"r - 'UShort_t' 0 - newVal u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face "
"u 'CalDigi::AdcRange' 'CalDigi::AdcRange' 0 LowEnX4 range",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setAdcRangeScale",1577,G__CalDigi_setAdcRangeScale_6_1,98,-1,G__defined_typename("Bool_t"),0,3,1,1,0,
"r - 'UShort_t' 0 - newVal u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face "
"u 'CalDigi::AdcRange' 'CalDigi::AdcRange' 0 LowEnX4 range",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setAdcWord",1008,G__CalDigi_setAdcWord_7_1,121,-1,-1,0,3,1,1,0,
"r - 'UShort_t' 0 - newVal u 'CalDigi::LogFace' 'CalDigi::LogFace' 0 - face "
"u 'CalDigi::AdcRange' 'CalDigi::AdcRange' 0 LowEnX4 range",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setTriggerMode",1445,G__CalDigi_setTriggerMode_8_1,121,-1,-1,0,1,1,1,0,"u 'CalDigi::CalTrigMode' 'CalDigi::CalTrigMode' 0 - val",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getCalLogId",1055,G__CalDigi_getCalLogId_9_1,85,G__get_linked_tagnum(&G__EventCintLN_CalLogId),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class",502,G__CalDigi_Class_0_2,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Name",982,G__CalDigi_Class_Name_1_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__CalDigi_Class_Version_2_2,115,-1,G__defined_typename("Version_t"),0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__CalDigi_Dictionary_3_2,121,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__CalDigi_IsA_4_2,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__CalDigi_ShowMembers_5_2,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__CalDigi_Streamer_6_2,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("StreamerNVirtual",1656,G__CalDigi_StreamerNVirtual_7_2,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__CalDigi_DeclFileName_8_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__CalDigi_DeclFileLine_9_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__CalDigi_ImplFileName_0_3,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__CalDigi_ImplFileLine_1_3,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("CalDigi",653,G__CalDigi_CalDigi_2_3,(int)('i'),G__get_linked_tagnum(&G__EventCintLN_CalDigi),-1,0,1,1,1,0,"u 'CalDigi' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~CalDigi",779,G__CalDigi_wACalDigi_3_3,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncTkrDigi(void) {
   ...
   G__memfunc_setup("TkrDigi",686,G__TkrDigi_TkrDigi_1_0,105,G__get_linked_tagnum(&G__EventCintLN_TkrDigi),-1,0,1,1,1,0,"U 'TObjArray' - 0 - strips",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Clean",483,G__TkrDigi_Clean_3_0,121,-1,-1,0,1,1,1,0,"C - 'Option_t' 0 \"\" option",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getStrips",965,G__TkrDigi_getStrips_4_0,85,G__get_linked_tagnum(&G__EventCintLN_TObjArray),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setToT",611,G__TkrDigi_setToT_5_0,121,-1,-1,0,2,1,1,0,
"h - 'UInt_t' 0 - right h - 'UInt_t' 0 - left",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setErrf",731,G__TkrDigi_setErrf_6_0,121,-1,-1,0,2,1,1,0,
"h - 'UInt_t' 0 - right h - 'UInt_t' 0 - left",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setLayerNum",1145,G__TkrDigi_setLayerNum_7_0,121,-1,-1,0,1,1,1,0,"b - 'UChar_t' 0 - layerVal",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setXY",509,G__TkrDigi_setXY_8_0,121,-1,-1,0,1,1,1,0,"u 'TkrDigi::TKRAxes' 'TkrDigi::TKRAxes' 0 - xyVal",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getToT",599,G__TkrDigi_getToT_9_0,105,-1,G__defined_typename("Int_t"),0,1,1,1,0,"b - 'UChar_t' 0 - ctrlNum",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getErrf",719,G__TkrDigi_getErrf_0_1,105,-1,G__defined_typename("Int_t"),0,1,1,1,0,"b - 'UChar_t' 0 - ctrlNum",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getLayerNum",1133,G__TkrDigi_getLayerNum_1_1,98,-1,G__defined_typename("UChar_t"),0,0,1,1,8,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getXY",497,G__TkrDigi_getXY_2_1,105,G__get_linked_tagnum(&G__EventCintLN_TkrDigicLcLTKRAxes),G__defined_typename("TkrDigi::TKRAxes"),0,0,1,1,8,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getNumHits",1032,G__TkrDigi_getNumHits_3_1,104,-1,G__defined_typename("UInt_t"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getHit",613,G__TkrDigi_getHit_4_1,85,G__get_linked_tagnum(&G__EventCintLN_StripId),-1,0,1,1,1,0,"i - - 0 - i",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Compare",711,G__TkrDigi_Compare_5_1,105,-1,G__defined_typename("Int_t"),0,1,1,1,8,"U 'TObject' - 10 - obj",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("IsSortable",1016,G__TkrDigi_IsSortable_6_1,98,-1,G__defined_typename("Bool_t"),0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Class",502,G__TkrDigi_Class_7_1,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Name",982,G__TkrDigi_Class_Name_8_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__TkrDigi_Class_Version_9_1,115,-1,G__defined_typename("Version_t"),0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__TkrDigi_Dictionary_0_2,121,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__TkrDigi_IsA_1_2,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__TkrDigi_ShowMembers_2_2,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__TkrDigi_Streamer_3_2,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("StreamerNVirtual",1656,G__TkrDigi_StreamerNVirtual_4_2,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__TkrDigi_DeclFileName_5_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__TkrDigi_DeclFileLine_6_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__TkrDigi_ImplFileName_7_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__TkrDigi_ImplFileLine_8_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("TkrDigi",686,G__TkrDigi_TkrDigi_9_2,(int)('i'),G__get_linked_tagnum(&G__EventCintLN_TkrDigi),-1,0,1,1,1,0,"u 'TkrDigi' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~TkrDigi",812,G__TkrDigi_wATkrDigi_0_3,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncEvent(void) {
   ...
   G__memfunc_setup("addAcdDigi",942,G__Event_addAcdDigi_9_0,85,G__get_linked_tagnum(&G__EventCintLN_AcdDigi),-1,0,1,1,1,0,"r - 'UShort_t' 0 - id",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("getCalDigi",973,G__Event_getCalDigi_1_1,85,G__get_linked_tagnum(&G__EventCintLN_TClonesArray),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("addCalDigi",950,G__Event_addCalDigi_2_1,85,G__get_linked_tagnum(&G__EventCintLN_CalDigi),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("getTkrDigi",1006,G__Event_getTkrDigi_4_1,85,G__get_linked_tagnum(&G__EventCintLN_TObjArray),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("addTkrDigi",983,G__Event_addTkrDigi_5_1,121,-1,-1,0,1,1,1,0,"U 'TkrDigi' - 0 - layer",(char*)NULL,(void*)NULL,0);
...
G__linked_taginfo G__EventCintLN_AcdDigicLcLdA = { "AcdDigi::$" , 101 , -1 };
...
G__linked_taginfo G__EventCintLN_CalDigicLcLAdcRange = { "CalDigi::AdcRange" , 101 , -1 };
G__linked_taginfo G__EventCintLN_CalDigicLcLLogFace = { "CalDigi::LogFace" , 101 , -1 };
G__linked_taginfo G__EventCintLN_CalDigicLcLCalTrigMode = { "CalDigi::CalTrigMode" , 101 , -1 };
G__linked_taginfo G__EventCintLN_CalDigicLcLdA = { "CalDigi::$" , 101 , -1 };
...
G__linked_taginfo G__EventCintLN_TkrDigicLcLTKRAxes = { "TkrDigi::TKRAxes" , 101 , -1 };
...
extern "C" void G__cpp_reset_tagtableEventCint() {
  ...
  G__EventCintLN_AcdDigicLcLdA.tagnum = -1 ;
  ...
  G__EventCintLN_CalDigicLcLAdcRange.tagnum = -1 ;
  G__EventCintLN_CalDigicLcLLogFace.tagnum = -1 ;
  G__EventCintLN_CalDigicLcLCalTrigMode.tagnum = -1 ;
  G__EventCintLN_CalDigicLcLdA.tagnum = -1 ;
  ...
  G__EventCintLN_TkrDigicLcLTKRAxes.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableEventCint() {
   ...
   G__tagtable_setup(G__get_linked_tagnum(&G__EventCintLN_AcdDigi),sizeof(AcdDigi),-1,29952,"Digitization for a single ACD Tile",G__setup_memvarAcdDigi,G__setup_memfuncAcdDigi);
   ...
   G__tagtable_setup(G__get_linked_tagnum(&G__EventCintLN_CalDigi),sizeof(CalDigi),-1,29952,"Digitization for a single Cal Log",G__setup_memvarCalDigi,G__setup_memfuncCalDigi);
   ...
   G__tagtable_setup(G__get_linked_tagnum(&G__EventCintLN_TkrDigi),sizeof(TkrDigi),-1,29952,"Information on a single tracker layer	   ",G__setup_memvarTkrDigi,G__setup_memfuncTkrDigi);
