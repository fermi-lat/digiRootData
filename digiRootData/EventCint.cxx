//
// File generated by C:\heather\extlib\Root\v3\bin\rootcint at Wed Jun 20 14:57:22 2001.
...
static int G__TkrLayer_TkrLayer_1_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   TkrLayer *p=NULL;
      p = new TkrLayer((TClonesArray*)G__int(libp->para[0]));
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__EventCintLN_TkrLayer);
...
static int G__TkrLayer_setLayer_7_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__TkrLayer_getLayer_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__TkrLayer_AddStrip_3_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((TkrLayer*)(G__getstructoffset()))->AddStrip());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_Compare_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((const TkrLayer*)(G__getstructoffset()))->Compare((const TObject*)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_IsSortable_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((const TkrLayer*)(G__getstructoffset()))->IsSortable());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_Class_6_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((TkrLayer*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_Class_Name_7_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((TkrLayer*)(G__getstructoffset()))->Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_Class_Version_8_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((TkrLayer*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_Dictionary_9_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrLayer*)(G__getstructoffset()))->Dictionary();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_IsA_0_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((const TkrLayer*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_ShowMembers_1_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrLayer*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_Streamer_2_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrLayer*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_StreamerNVirtual_3_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((TkrLayer*)(G__getstructoffset()))->StreamerNVirtual(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_DeclFileName_4_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((TkrLayer*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_DeclFileLine_5_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((TkrLayer*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_ImplFileName_6_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((TkrLayer*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TkrLayer_ImplFileLine_7_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((TkrLayer*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__TkrLayer_TkrLayer_8_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   TkrLayer *p;
...
static int G__TkrLayer_wATkrLayer_9_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
...
static void G__setup_memvarTkrLayer(void) {
   ...
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__EventCintLN_TClonesArray),-1,-1,4,"m_strips=",0,"->");
...
static void G__setup_memfuncTkrLayer(void) {
   ...
   G__memfunc_setup("TkrLayer",814,G__TkrLayer_TkrLayer_1_0,105,G__get_linked_tagnum(&G__EventCintLN_TkrLayer),-1,0,1,1,1,0,"U 'TClonesArray' - 0 - strips",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Clean",483,G__TkrLayer_Clean_3_0,121,-1,-1,0,1,1,1,0,"C - 'Option_t' 0 \"\" option",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getStrips",965,G__TkrLayer_getStrips_4_0,85,G__get_linked_tagnum(&G__EventCintLN_TClonesArray),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setTOT",579,G__TkrLayer_setTOT_5_0,121,-1,-1,0,2,1,1,0,
...
"h - 'UInt_t' 0 - right h - 'UInt_t' 0 - left",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("setLayer",841,G__TkrLayer_setLayer_7_0,121,-1,-1,0,1,1,1,0,"b - 'UChar_t' 0 - layerVal",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("getTOT",567,G__TkrLayer_getTOT_9_0,105,-1,G__defined_typename("Int_t"),0,1,1,1,0,"b - 'UChar_t' 0 - ctrlNum",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("getLayer",829,G__TkrLayer_getLayer_1_1,98,-1,G__defined_typename("UChar_t"),0,0,1,1,8,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("AddStrip",795,G__TkrLayer_AddStrip_3_1,85,G__get_linked_tagnum(&G__EventCintLN_StripID),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Compare",711,G__TkrLayer_Compare_4_1,105,-1,G__defined_typename("Int_t"),0,1,1,1,8,"U 'TObject' - 10 - obj",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("IsSortable",1016,G__TkrLayer_IsSortable_5_1,98,-1,G__defined_typename("Bool_t"),0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Class",502,G__TkrLayer_Class_6_1,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Name",982,G__TkrLayer_Class_Name_7_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__TkrLayer_Class_Version_8_1,115,-1,G__defined_typename("Version_t"),0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__TkrLayer_Dictionary_9_1,121,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__TkrLayer_IsA_0_2,85,G__get_linked_tagnum(&G__EventCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__TkrLayer_ShowMembers_1_2,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__TkrLayer_Streamer_2_2,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("StreamerNVirtual",1656,G__TkrLayer_StreamerNVirtual_3_2,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__TkrLayer_DeclFileName_4_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__TkrLayer_DeclFileLine_5_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__TkrLayer_ImplFileName_6_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__TkrLayer_ImplFileLine_7_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("TkrLayer",814,G__TkrLayer_TkrLayer_8_2,(int)('i'),G__get_linked_tagnum(&G__EventCintLN_TkrLayer),-1,0,1,1,1,0,"u 'TkrLayer' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~TkrLayer",940,G__TkrLayer_wATkrLayer_9_2,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   G__tag_memfunc_reset();
}
